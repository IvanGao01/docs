...
| Parameter | Default                                 | Environment Variables | Introduction                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------- | --------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| trace parallelism of the reporter, default value is 2                                                                                               | Default                                                | Environment Variables                                                               | Description                                                              |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| path                                                                                                                                                | HintedOff storage directory, default: `/tmp/cnosdb/hh` | If this field is true, it means that the node is not used when allocating vnode     | Data storage location                                                    |
...
| path                                                                               | `/var/lib/cnosdb/wal` | `[heartbeat]`:  check CnosDB node status configurations periodically                                                                            | WAL Storage Directory.                                                               |
...
| path      | `[log]`: run log configuration | `[node_basic]` node configuration (v2.3.0) | Remote log path                                                        |
...
| path      | `/var/lib/cnosdb/h` | This field indicates how often the node reports the time stamp, disk remaining amount and other information to the meta node | HintedOff storage directory.                               |
...
| Parameter **mode** can be selected from the following values: | Default | Environment Variables                                             | Description         |
| ------------------------------------------------------------- | ------- | ----------------------------------------------------------------- | ------------------- |
| path                                                          | None    | `[heartbeat]` heartbeat configuration (v2.3.0) | trace log file path |
...
| Parameter                                                        | Default | Environment Variables                                            | Description                                                                                                                                   |
| ---------------------------------------------------------------- | ------- | ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| jaeger_agent_endpoint  | None    | `CNOSDB_JAEGER_AGENT_ENDPOINT`                                   | the Jaeger agent endpoint.eg: http\://localhost:14268/api/traceseg：http\://localhost:14268/api/traces                                         |
| max_concurrent_exports | 3       | `reporting_disabled` Whether to turn off information collection. | The parallelism of the reporter on trace.Default value is 2                                                                                   |
...
| Parameter                      | Default                | Environment Variables                                                                 | The detailed configuration file description is as follows:                |
| ------------------------------ | ---------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
...
| Post                           | `127.0.0.1`            | **Description**: node host, used to communicate with other nodes, default: localhost. | `host` for communication with other nodes                                 |
