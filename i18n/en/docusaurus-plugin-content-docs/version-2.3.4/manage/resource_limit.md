...
| Parameter name                                             | NAME                                                                                                                                 | Required | Units                                 |
| :--------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------- | :------- | :------------------------------------ |
...
| max_return_time  | Specifies the maximum TTL parameter of the database under the tenant. When null, it is unlimited.                                    | Yes      | **Return Type**：Consistent with expr. |
...
| `[query]` query interface configuration | NAME                                             | Units |
| :-------------------------------------- | :----------------------------------------------- | :---- |
| max                                     | Limit the maximum number of tokens in a bucket   | one   |
| Initial                                 | Limit the number of tokens in the initial bucket | one   |
