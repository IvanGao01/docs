...
> Host of service External tables do not exist in the database, but an operating system file is accessed as a common database table. Stream
...
Multi-linestringTenant name of the table

DescriptionData Query
...
Description-- station is a Tag column, temperature is a Field Namecolumn.
SELECT station, temperature FROM air;
